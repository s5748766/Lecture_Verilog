...
#define ALU_REG_CONTROL     0x08
#define ALU_REG_RESULT      0x0C
                           ...
                           const char *buf, size_t count)
{
    ...
    ctrl = alu_read_reg(lp, ALU_REG_CONTROL);
    ctrl = (ctrl & 0xFFFFFFF8) | (val & 0x7);
    alu_write_reg(lp, ALU_REG_CONTROL, ctrl);
    return count;
}
